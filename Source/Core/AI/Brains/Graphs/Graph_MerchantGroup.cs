...
namespace RA
{
    public class Graph_MerchantGroup
    {
        ...
        public static StateGraph ArrivalGraph(Building_TradingPost tradingPost)
        {
            ...
            var stateTravel = new State_MerchantArrive(tradingPost);
            ...
            transitionAttackedDefend.preActions.Add(new TransitionAction_RenewDefence());
