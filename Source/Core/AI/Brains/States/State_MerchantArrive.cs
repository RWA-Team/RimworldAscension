...
namespace RA
{
    public class State_MerchantArrive : State
    {
        public Building_TradingPost tradingPost;
        public IntVec3 merchantDest, animalDest;
        public Pawn merchant, animal;

        public State_MerchantArrive()
        {
        }

        public State_MerchantArrive(Building_TradingPost tradingPost)
        {
        ...
        // should define duties in that state
