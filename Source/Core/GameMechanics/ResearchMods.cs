...
namespace RA
{
    public static class ResearchMods
    {
        #region DATA
        /*
            ThingDef.Named("CraftsmanBench"),
            ThingDef.Named("WarriorsBench"),
            ThingDef.Named("HuntersBench")
            DefDatabase<RecipeDef>.GetNamedSilentFail("Make_Dagger"),
            DefDatabase<RecipeDef>.GetNamedSilentFail("Make_Spear"),
            DefDatabase<RecipeDef>.GetNamedSilentFail("Make_Club")
         */
        ...
        public static void WoodWorking()
        {
            ...
            TryAllowToCraft("Make_Dagger", false, "StoneWorking", "BoneWorking");
        ...
        public static void StoneWorking()
        {
            ...
            TryAllowToCraft("Make_Dagger", true, "WoodWorking");
            AddResourceTypeToRecipe("Make_Dagger", "StoneBlocks");
        ...
        public static void BoneWorking()
        {
            ...
            TryAllowToCraft("Make_Dagger", true, "WoodWorking");
            AddResourceTypeToRecipe("Make_Dagger", "Bone");
            TryAllowToCraft("Make_Spear", true, "WoodWorking");
