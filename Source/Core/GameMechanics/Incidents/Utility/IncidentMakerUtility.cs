...
namespace RA
{
    public static class IncidentMakerUtility
    {
        ...
        public static IncidentParms DefaultParmsNow(StorytellerDef tellerDef, IncidentCategory category)
        {
            IncidentParms incidentParms = new IncidentParms();
            if (category == IncidentCategory.ThreatSmall || category == IncidentCategory.ThreatBig)
            {
