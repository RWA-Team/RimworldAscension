...
namespace RimworldAscension
{
    ...
    {
        public const float PointsPer1000Wealth = 12.5f;
        public const float PointsPerColonist = 43f;
        public const float WealthBuildingsModifier = 0.5f;
        public const float MinMaxSquadCost = 50f;
