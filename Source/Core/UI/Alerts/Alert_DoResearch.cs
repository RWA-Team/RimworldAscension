...
namespace RA
{
    public class Alert_DoResearch : Alert_High
    {
        public override AlertReport Report
        {
            get
            {
                if (Find.ResearchManager.IsFinished(ResearchProjectDef.Named("SurvivalGuideI")) || Find.ListerBuildings.allBuildingsColonist.Any(building => building.TryGetComp<CompResearcher>() != null))
                {
